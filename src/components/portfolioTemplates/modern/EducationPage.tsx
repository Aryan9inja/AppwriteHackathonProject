...
import { GraduationCap, MapPin, Calendar, School, Award, BookOpen, ChevronRight } from 'lucide-react';
    ...
    return (
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        <div className="bg-white/90 backdrop-blur-md shadow-xl border border-blue-200 rounded-2xl p-12 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">No Education Added</h2>
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      ...
      <div className="bg-white/90 backdrop-blur-md shadow-2xl border border-blue-200 rounded-3xl p-8 md:p-12 mb-12 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-blue-400/10 to-green-400/10 rounded-full blur-2xl"></div>
        
        <div className="relative text-center">
          <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center text-white mx-auto mb-6 shadow-2xl">
            <GraduationCap className="w-10 h-10" />
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
            Educational Journey
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            The academic foundation that has shaped my knowledge and expertise
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/90 backdrop-blur-md shadow-xl border border-blue-200 rounded-2xl p-8 md:p-12">
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-green-500 via-emerald-500 to-cyan-500 rounded-full"></div>
          
          <div className="space-y-12">
            {data.education.map((edu, index) => (
              <div key={index} className="relative pl-20">
                {/* Timeline Dot */}
                <div className="absolute -left-4 top-0 w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-lg border-4 border-white">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                </div>
                
                {/* Education Card */}
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105 group">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xl text-green-600 font-semibold">{edu.institution}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 text-green-500 group-hover:text-green-600 transition-colors">
                  ...
                  <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-white/50">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-gray-700 font-medium">Academic Achievement</p>
                        <p className="text-sm text-gray-600">
                          Completed comprehensive coursework in {edu.degree.toLowerCase()}
                        </p>
                      </div>
                      {edu.gpa && (
      ...
      <div className="mt-12 grid md:grid-cols-3 gap-6">
        <div className="bg-white/90 backdrop-blur-md shadow-xl border border-blue-200 rounded-2xl p-6 text-center hover:shadow-2xl transition-shadow">
          <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-white text-xl font-bold mx-auto mb-4">
            {data.education.length}
          </div>
          <h3 className="text-lg font-bold text-gray-900 mb-2">Degrees</h3>
        ...
        <div className="bg-white/90 backdrop-blur-md shadow-xl border border-blue-200 rounded-2xl p-6 text-center hover:shadow-2xl transition-shadow">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">Institutions</h3>
          <p className="text-gray-600">Educational establishments</p>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-md shadow-xl border border-blue-200 rounded-2xl p-6 text-center hover:shadow-2xl transition-shadow">
          ...
          <p className="text-gray-600">Academic achievement</p>
        </div>
      </div>
        ...
        <div className="mt-12 bg-white/90 backdrop-blur-md shadow-xl border border-blue-200 rounded-2xl p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {data.certifications.map((cert, index) => (
              <div key={index} className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="mt-12 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">See how I've applied my education in real-world scenarios</p>
