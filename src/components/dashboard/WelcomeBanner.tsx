  ...
  return (
    ...
    >
      <div className="relative">
        {/* Very subtle neutral border effect */}
        <div className="relative bg-card/50 dark:bg-card/30 rounded-lg sm:rounded-xl lg:rounded-2xl p-4 sm:p-5 lg:p-6 border border-border/50 dark:border-border/30 backdrop-blur-sm">
